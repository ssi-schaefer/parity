...
namespace parity
{
	namespace testing
	{
		...
		bool TestSuite::testParityExeNoLoad()
		{
			try {
				...
				utils::Path libcfile = utils::Path::getTemporary(".parity.testsuite.library.no.load.XXXXXX.c");
				utils::Path oexefile = utils::Path::getTemporary(".parity.testsuite.no.load.XXXXXX.exe");
				utils::Path olibfile = utils::Path::getTemporary(".parity.testsuite.no.load.XXXXXX.so");
